...
import { getDaysInMonth, getFirstDayOfMonth, getDayName, formatCurrency, extractDatePart } from '../../lib/date-utils'
...
export function MonthGrid({ year, month, events, transactions, selectedDate, onDateClick }: MonthGridProps) {
        ...
        <Div className="bg-white rounded-xl border border-gray-200 flex flex-col h-full">
            ...
            <Div className="flex-1 flex flex-col">
                {weeks.map((week, weekIndex) => {
                    ...
                    return (
                        <Div key={weekIndex} className="grid grid-cols-7 flex-1 border-b border-gray-100 last:border-b-0 min-h-[120px]">
