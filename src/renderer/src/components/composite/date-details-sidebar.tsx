        ...
        <Div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <Div className="grid grid-cols-2 gap-4 mb-6">
                <Div className="p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                    <Typography as="div" className="text-sm text-green-700 mb-1">수입</Typography>
                    <Typography as="div" className="text-xl font-bold text-green-600">
                        {formatCurrency(income)}
                    </Typography>
                </Div>
                <Div className="p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                    <Typography as="div" className="text-sm text-red-700 mb-1">지출</Typography>
            ...
            <Div>
                <Div className="flex items-center justify-between mb-3">
                    <Typography as="h4" className="font-semibold text-gray-800">거래</Typography>
                ...
                {transactions.length === 0 ? (
                    <Typography as="p" className="text-sm text-gray-500 italic">거래 내역 없음</Typography>
                ) : (
                    <Div className="space-y-2">
