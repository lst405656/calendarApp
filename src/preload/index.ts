...
const api = {
  getEvents: (startDate: string, endDate: string) => ipcRenderer.invoke('get-events', startDate, endDate),
  ...
  getTransactions: (startDate: string, endDate: string) => ipcRenderer.invoke('get-transactions', startDate, endDate),
